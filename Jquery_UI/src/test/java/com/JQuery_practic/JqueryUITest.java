...
public class JqueryUITest {
	...
	public void interactions() {
		try {
			...
			driver.switchTo().frame(0);
			WebElement sortableElem1 = driver
					.findElement(By.xpath("(//li[@class='ui-state-default ui-sortable-handle'])[1]"));
			WebElement sortableElem2 = driver
					.findElement(By.xpath("(//li[@class='ui-state-default ui-sortable-handle'])[2]"));
			WebElement sortableElem3 = driver
					.findElement(By.xpath("(//li[@class='ui-state-default ui-sortable-handle'])[3]"));
			WebElement sortableElem4 = driver
					.findElement(By.xpath("(//li[@class='ui-state-default ui-sortable-handle'])[4]"));
			WebElement sortableElem5 = driver
					.findElement(By.xpath("(//li[@class='ui-state-default ui-sortable-handle'])[5]"));
			WebElement sortableElem6 = driver
					.findElement(By.xpath("(//li[@class='ui-state-default ui-sortable-handle'])[6]"));
			WebElement sortableElem7 = driver
					.findElement(By.xpath("(//li[@class='ui-state-default ui-sortable-handle'])[7]"));

			Thread.sleep(1000);
			action.clickAndHold().moveToElement(sortableElem1).clickAndHold().moveToElement(sortableElem2).build()
					.perform();
			Thread.sleep(1000);
			action.clickAndHold().moveToElement(sortableElem2).clickAndHold().moveToElement(sortableElem3).build()
					.perform();
			Thread.sleep(1000);
			action.clickAndHold().moveToElement(sortableElem3).clickAndHold().moveToElement(sortableElem4).build()
					.perform();
			Thread.sleep(1000);
			action.clickAndHold().moveToElement(sortableElem4).clickAndHold().moveToElement(sortableElem5).build()
					.perform();
			Thread.sleep(1000);
			action.clickAndHold().moveToElement(sortableElem5).clickAndHold().moveToElement(sortableElem6).build()
					.perform();
			Thread.sleep(1000);
			action.clickAndHold().moveToElement(sortableElem6).clickAndHold().moveToElement(sortableElem7).build()
					.perform();
			Thread.sleep(1000);
		} catch (Exception e) {
			e.printStackTrace();
